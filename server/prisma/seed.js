...
const products = [
  ...
  { name: 'Casaco Corta-Vento', slug: 'casaco-corta-vento', description: 'Casaco leve e resistente à água, ideal para dias de vento.', priceCents: 7990, stock: 15, category: 'vestuario', featured: true },
  ...
  { name: 'Ténis Urbano Branco', slug: 'tenis-urbano-branco', description: 'Ténis minimalista em couro sintético, sola em borracha.', priceCents: 6990, stock: 30, category: 'calcado', featured: true },
  ...
  { name: 'Candeeiro de Mesa Minimalista', slug: 'candeeiro-mesa-minimalista', description: 'Candeeiro em madeira e linho, luz quente regulável.', priceCents: 5490, stock: 12, category: 'casa', featured: true },
  ...
  { name: 'Auscultadores Bluetooth', slug: 'auscultadores-bluetooth', description: 'Cancelamento de ruído ativo e 30h de autonomia.', priceCents: 8990, stock: 20, category: 'tecnologia', featured: true },
